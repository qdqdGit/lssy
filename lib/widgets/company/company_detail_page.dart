...
import 'package:lssy/common/widget/scroll_img_item.dart';
import 'package:lssy/model/company.dart';
import 'package:lssy/model/company_detail.dart';
import 'package:lssy/widgets/gallery_page.dart';
import 'package:lssy/widgets/company/welfare_item.dart';
...
class _CompanyDetailPageState extends State<CompanyDetailPage> with SingleTickerProviderStateMixin{
  ...
  _scrollListener(){
    setState(() {
      if(_scrollController.offset >= 56 && _isShow == false){
        _isShow = false;
